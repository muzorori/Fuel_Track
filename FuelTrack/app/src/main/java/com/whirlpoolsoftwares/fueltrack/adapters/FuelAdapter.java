...
public class FuelAdapter extends RecyclerView.Adapter<FuelAdapter.ViewHolder> {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fuel.getStatus().equals("Available")){
                    ...
                    builder.setTitle(fuel.getName() + " is currently unavailable")
                            .setMessage("You will be notified when " + fuel.getName() + " is available again at no extra cost.")
    ...
    public FuelAdapter(FragmentManager f, ActionBar toolbar){
        ...
        fuels.add(fuel);
        fuel = new Fuel("Parrafin","Not Available");
        fuels.add(fuel);
    }
